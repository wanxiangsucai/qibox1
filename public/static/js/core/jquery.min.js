...
include_js("/public/static/layui/layui.js");
*/
...
function img_center(e) {
	var parent = e.parentNode;
	if(parent.nodeName=='A' && parent.className!='img'){
		parent = parent.parentNode
	}	
	var wid = parent.offsetWidth;//父容器限制高度
	var hei = parent.offsetHeight;//父容器限制宽度
...
document.write('<script LANGUAGE="JavaScript" src="/public/static/js/msg.js"></script>');
document.write('<script LANGUAGE="JavaScript" src="/public/static/libs/viewer/viewer-jquery.min.js"></script>');
document.write('<link rel="stylesheet" href="/public/static/libs/viewer/viewer.min.css">');
