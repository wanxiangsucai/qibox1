...
CREATE TABLE `qb_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='管理员常用菜单';
...
CREATE TABLE `qb_alonepage` (
  ...
  KEY `status` (`status`),
  KEY `list` (`list`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='单篇文章独立页';
...
CREATE TABLE `qb_comment_content` (
  ...
  KEY `aid` (`aid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='评论内容表';
...
CREATE TABLE `qb_config` (
  ...
  KEY `sys_type` (`sys_id`),
  KEY `c_key` (`c_key`)
) ENGINE=MyISAM AUTO_INCREMENT=656 DEFAULT CHARSET=utf8 COMMENT='系统参数配置';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='可供使用的接口钩子功能';
...
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='后台操作日志';
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户登录日志';
...
CREATE TABLE `qb_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='频道模块列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='购物车';
...
CREATE TABLE `qb_shop_content1` (
  ...
  `ext_id` int(8) NOT NULL COMMENT '扩展字段,供其它调用',
  `myfid` mediumint(7) NOT NULL COMMENT '我的分类',
  `num` mediumint(6) NOT NULL DEFAULT '500' COMMENT '库存量',
  `market_price` decimal(10,2) NOT NULL COMMENT '市场原价',
  PRIMARY KEY (`id`),
  KEY `mid` (`mid`),
  KEY `fid` (`fid`),
  KEY `view` (`view`),
  ...
  KEY `ext_id_2` (`ext_id`,`ext_sys`),
  KEY `myfid` (`myfid`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品内容表';
...
CREATE TABLE `qb_shop_mysort` (
  ...
  KEY `pid` (`pid`),
  KEY `list` (`list`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户自定义商品分类';
...
CREATE TABLE `qb_shop_sort` (
  ...
  KEY `pid` (`pid`),
  KEY `list` (`list`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='主栏目表';
...
INSERT INTO `qb_alonepage` VALUES ('8','欢迎关注官方微信','欢迎关注公众号','1447747983','','do/weixin.htm','','','<p style=\"text-align:center;\"><br/></p><p>亲爱的会员，</p><p>&nbsp; 本站会员微信官方账号现已开通，您可以通过“扫一扫”功能或查找公众号中输入“齐博软件”即可添加。最新、最热的活动资讯将第一时间通知到您！</p><p><br/></p><p style=\"text-align:center;\"><img src=\"http://bbs.qibosoft.com/attachment123456br666vh00/Day_140402/10312_243423_d93579d4987ee55.jpg\" width=\"430\" height=\"430\"/><br/></p>','28','0','','0');
...
INSERT INTO `qb_config` VALUES ('29','2','是否对图片加水印','is_waterimg','2','radio','1|启用\n2|禁用','1','','','0','0');
INSERT INTO `qb_config` VALUES ('62','8','是否允许重复的邮箱','emailOnly','1','radio','0|允许重复\r\n1|不允许重复','1','','','97','0');
INSERT INTO `qb_config` VALUES ('81','0','论坛接口数据表前缀','passport_pre','`bbs`.pw_','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('82','0','是否整合论坛','passport_type','','text','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('89','20','QQ登录接口ID','qqlogin_appid','','text','','1','','','0','-9');
...
INSERT INTO `qb_config` VALUES ('163','1','网站风格','style','default','select','app\\common\\util\\Style@listStyle','1','','','99','0');
INSERT INTO `qb_config` VALUES ('172','1','COOKIE前缀','cookiePre','','','','1','','安装多份系统才面要，默认留空','0','0');
...
INSERT INTO `qb_config` VALUES ('300','1','百度地图KEY','baidu_map_key','','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('302','1','COOKIE域名','cookieDomain','','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('303','1','是否关闭网站调试','forbid_show_bug','1','radio','0|调试 还没上线\n1|关闭调试 正式运营','1','','','0','0');
INSERT INTO `qb_config` VALUES ('305','1','远程附件地址','remote_updir','','text','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('306','1','上传文件的最大尺寸','upfileMaxSize','','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('307','1','允许上传文件的类型','upfileType','.rar .txt .jpg .gif .bmp .png .zip .mp3 .wma .wmv .mpeg .mpg .rm .ram .htm .doc .swf .avi .flv .sql .doc .ppt .xls .chm .pdf .mp4 .pem','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('643','1','会员中心风格','member_style','default','select','app\\common\\util\\Style@get_style@[\"member\"]','1','','','98','0');
INSERT INTO `qb_config` VALUES ('313','1','站点关闭原因','close_why','网站维护当中,暂停访问.','text','','1','','','0','0');
...
INSERT INTO `qb_config` VALUES ('339','4','微信公众号TOKEN','weixin_token','','text','','1','','微信服务器地址(URL)那里输入的网址是 http://你的域名/p/weixin-api-index.html','98','-2');
...
INSERT INTO `qb_config` VALUES ('425','1','积分名称','MoneyName','金币','text','','1','','可以取名为积分、金币','0','0');
INSERT INTO `qb_config` VALUES ('433','1','站点加密字符串','mymd5','34d63833b520ea','text','','1','','设置后就不要随意修改，不然会影响到之前的数据','0','0');
INSERT INTO `qb_config` VALUES ('439','11','wap版支付宝接口合作者身份','wap_ali_partner','','text','','1','','','98','0');
INSERT INTO `qb_config` VALUES ('440','11','wap版支付宝接口私钥','wap_ali_private_key','','text','','1','','这一项可以留空，使用默认的','96','0');
...
INSERT INTO `qb_config` VALUES ('447','6','模块红包','RegHongBao','0.100','text','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('451','13','微信公众号二维码图片','weixin_code_img','http://www.wxyxpt.com/upload_files/web1/wenxin_center/49b_1_20160923120948_nu45d.jpg','image','','1','','','0','-2');
INSERT INTO `qb_config` VALUES ('466','1','积分单位','MoneyDW','元','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('467','11','PC版支付宝接口类型','alipay_service','create_direct_pay_by_user','radio','create_direct_pay_by_user|即时到账\r\n','1','','只能选择第一项','86','0');
INSERT INTO `qb_config` VALUES ('468','11','wap版支付宝接口收款帐号','wap_ali_id','','text','','1','','','99','0');
...
INSERT INTO `qb_config` VALUES ('476','6','地要','reg_group00','','text','','1','','','0','0');
...
INSERT INTO `qb_config` VALUES ('482','1','购买用户组有效天数','group_expire_data','365','number','','1','','','0','0');
...
INSERT INTO `qb_config` VALUES ('490','4','微信企业帐户可用余额','weixinTotalMoney','','text','','1','','填写的数值小于或等于企业帐户里的可用余额，当数值小于1时，系统将无法给会员微信付款','0','-2');
...
INSERT INTO `qb_config` VALUES ('505','16','SEO标题','mseo_title','','text','','0','','','100','2');
INSERT INTO `qb_config` VALUES ('506','16','SEO优化关键字keywords','mseo_keyword','','text','','0','','','99','2');
INSERT INTO `qb_config` VALUES ('507','16','SEO优化描述description','mseo_description','','text','','0','','','98','2');
INSERT INTO `qb_config` VALUES ('508','16','是否开启当前模块','is_open_modlue','1','radio','1|开启\n0|关闭','0','','','97','2');
INSERT INTO `qb_config` VALUES ('509','16','允许发布商品的用户组','can_post_group','','checkbox','app\\common\\model\\Group@getTitleList@[{\"id\":[\"<>\",2]}]','0','','','96','2');
INSERT INTO `qb_config` VALUES ('510','16','发布商品自动通过审核的用户组','post_auto_pass_group','','checkbox','app\\common\\model\\Group@getTitleList@[{\"id\":[\"<>\",2]}]','0','','','95','2');
INSERT INTO `qb_config` VALUES ('515','16','是否允许删除已付款商品订单','can_del_ispay_order','','radio','1|允许\n0|不允许','0','','','94','2');
INSERT INTO `qb_config` VALUES ('516','16','客户下单是否短消息通知商家','post_order_msg_hy','','radio','1|通知\n0|不通知','0','','','93','2');
INSERT INTO `qb_config` VALUES ('517','16','客户下单是否短信通知商家','post_order_sms_hy','','radio','1|通知\n0|不通知','0','','','92','2');
INSERT INTO `qb_config` VALUES ('518','16','客户下单是否微信通知商家','post_order_wx_hy','','radio','1|通知\n0|不通知','0','','','91','2');
INSERT INTO `qb_config` VALUES ('519','16','客户付款成功是否短消息通知商家','pay_order_msg_hy ','','radio','1|通知\n0|不通知','0','','','90','2');
INSERT INTO `qb_config` VALUES ('520','16','客户付款成功是否短信通知商家','pay_order_sms_hy ','','radio','1|通知\n0|不通知','0','','','89','2');
INSERT INTO `qb_config` VALUES ('521','16','客户付款成功是否微信通知商家','pay_order_wx_hy','','radio','1|通知\n0|不通知','0','','','88','2');
INSERT INTO `qb_config` VALUES ('522','16','是否启用会员帐户余额付款','can_user_rmb_pay','','radio','1|启用\n0|关闭','0','','','87','2');
...
INSERT INTO `qb_config` VALUES ('635','31','阿里云短信接口id','sms_access_id','','text','','1','','即AccessKeyId','10','-11');
...
INSERT INTO `qb_config` VALUES ('644','1','后台风格','admin_style','default','select','app\\common\\util\\Style@get_style@[\"admin\"]','1','','','97','0');
...
INSERT INTO `qb_config` VALUES ('647','1','WAP端是否指定某个频道做为默认主页','set_module_wapindex','0','select','app\\common\\util\\Module@getTitleList@[\"不特别指定\",\"keywords\"]','1','','','0','0');
...
INSERT INTO `qb_config` VALUES ('651','1','网站域名网址','www_url','','text','','1','','一般请留空,如果你启用了https,服务器无法识别导致后台提交数据失败,就在这里输入详细的网址,比如https://xxxx.com','0','0');
...
INSERT INTO `qb_config` VALUES ('654','32','提现手续费','getout_percent_money','0','text','','0','','0即不收手续费,0.01即收取1个点的手续费','0','-5');
...
INSERT INTO `qb_config_group` VALUES ('13','微信其它设置','698','-2','0','1');
INSERT INTO `qb_config_group` VALUES ('16','基础设置','799','2','0','0');
...
INSERT INTO `qb_group` VALUES ('12','1','普通管理员','0','','1',NULL);
...
INSERT INTO `qb_log_action` VALUES ('1','1','1542375636','127.0.0.1','admin','group','admin_power','','{\"powerdb\":{\"base-admin-setting\\/index\":\"1\",\"base-admin-setting\\/clearcache\":\"1\",\"base-admin-plugin\\/index\":\"1\",\"base-admin-plugin\\/add\":\"1\",\"base-admin-plugin\\/market\":\"1\",\"base-admin-plugin\\/edit\":\"1\",\"base-admin-plugin\\/delete\":\"1\",\"base-admin-plugin\\/copy\":\"1\",\"base-admin-module\\/index\":\"1\",\"base-admin-module\\/add\":\"1\",\"base-admin-module\\/market\":\"1\",\"base-admin-module\\/edit\":\"1\",\"base-admin-module\\/delete\":\"1\",\"base-admin-module\\/copy\":\"1\",\"base-admin-hook\\/index\":\"1\",\"base-admin-hook\\/add\":\"1\",\"base-admin-hook\\/edit\":\"1\",\"base-admin-hook\\/delete\":\"1\",\"base-admin-hook_plugin\\/market\":\"1\",\"base-admin-hook_plugin\\/index\":\"1\",\"base-admin-hook_plugin\\/add\":\"1\",\"base-admin-hook_plugin\\/edit\":\"1\",\"base-admin-hook_plugin\\/delete\":\"1\",\"base-admin-admin_menu\\/index\":\"1\",\"base-admin-admin_menu\\/add\":\"1\",\"base-admin-admin_menu\\/edit\":\"1\",\"base-admin-admin_menu\\/delete\":\"1\",\"base-admin-member_menu\\/index\":\"1\",\"base-admin-member_menu\\/add\":\"1\",\"base-admin-member_menu\\/edit\":\"1\",\"base-admin-member_menu\\/delete\":\"1\",\"base-admin-member_menu\\/copy\":\"1\",\"base-admin-webmenu\\/index\":\"1\",\"base-admin-webmenu\\/add\":\"1\",\"base-admin-webmenu\\/edit\":\"1\",\"base-admin-webmenu\\/delete\":\"1\",\"base-admin-alonepage\\/index\":\"1\",\"base-admin-alonepage\\/add\":\"1\",\"base-admin-alonepage\\/edit\":\"1\",\"base-admin-alonepage\\/delete\":\"1\",\"base-admin-style\\/market\":\"1\",\"base-admin-style\\/add\":\"1\",\"base-admin-upgrade\\/index\":\"1\",\"base-admin-upgrade\\/sysup\":\"1\",\"base-admin-upgrade\\/check_files\":\"1\",\"base-admin-upgrade\\/view_file\":\"1\",\"base-admin-mysql\\/index\":\"1\",\"base-admin-mysql\\/backup\":\"1\",\"base-admin-mysql\\/showtable\":\"1\",\"base-admin-mysql\\/into\":\"1\",\"base-admin-mysql\\/tool\":\"1\",\"member-admin-member\\/index\":\"1\",\"member-admin-member\\/add\":\"1\",\"member-admin-member\\/edit\":\"1\",\"member-admin-member\\/delete\":\"1\",\"member-admin-group\\/index\":\"1\",\"member-admin-group\\/add\":\"1\",\"member-admin-group\\/edit\":\"1\",\"member-admin-group\\/delete\":\"1\",\"member-admin-group\\/admin_power\":\"1\",\"module-cms-setting\\/index\":\"1\",\"module-cms-content\\/postnew\":\"1\",\"module-cms-content\\/index\":\"1\",\"module-cms-content\\/add\":\"1\",\"module-cms-content\\/edit\":\"1\",\"module-cms-content\\/delete\":\"1\",\"module-cms-sort\\/index\":\"1\",\"module-cms-sort\\/add\":\"1\",\"module-cms-sort\\/edit\":\"1\",\"module-cms-sort\\/delete\":\"1\",\"module-cms-module\\/index\":\"1\",\"module-cms-module\\/add\":\"1\",\"module-cms-module\\/edit\":\"1\",\"module-cms-module\\/delete\":\"1\",\"module-cms-field\\/index\":\"1\",\"module-cms-field\\/add\":\"1\",\"module-cms-field\\/edit\":\"1\",\"module-cms-field\\/delete\":\"1\",\"module-cms-category\\/index\":\"1\",\"module-cms-category\\/add\":\"1\",\"module-cms-category\\/edit\":\"1\",\"module-cms-category\\/delete\":\"1\",\"module-cms-info\\/index\":\"1\",\"module-cms-info\\/add\":\"1\",\"module-cms-info\\/edit\":\"1\",\"module-cms-info\\/delete\":\"1\",\"module-cms-sort_field\\/index\":\"1\",\"module-cms-sort_field\\/add\":\"1\",\"module-cms-sort_field\\/edit\":\"1\",\"module-cms-sort_field\\/delete\":\"1\",\"module-shop-setting\\/index\":\"1\",\"module-shop-content\\/postnew\":\"1\",\"module-shop-content\\/index\":\"1\",\"module-shop-content\\/add\":\"1\",\"module-shop-content\\/edit\":\"1\",\"module-shop-content\\/delete\":\"1\",\"module-shop-sort\\/index\":\"1\",\"module-shop-sort\\/add\":\"1\",\"module-shop-sort\\/edit\":\"1\",\"module-shop-sort\\/delete\":\"1\",\"module-shop-module\\/index\":\"1\",\"module-shop-module\\/add\":\"1\",\"module-shop-module\\/edit\":\"1\",\"module-shop-module\\/delete\":\"1\",\"module-shop-field\\/index\":\"1\",\"module-shop-field\\/add\":\"1\",\"module-shop-field\\/edit\":\"1\",\"module-shop-field\\/delete\":\"1\",\"module-shop-order\\/index\":\"1\",\"module-shop-order\\/edit\":\"1\",\"module-shop-order\\/delete\":\"1\",\"module-shop-order\\/show\":\"1\",\"module-shop-sort_field\\/index\":\"1\",\"module-shop-sort_field\\/add\":\"1\",\"module-shop-sort_field\\/edit\":\"1\",\"module-shop-sort_field\\/delete\":\"1\",\"module-shop-order_field\\/index\":\"1\",\"module-shop-order_field\\/add\":\"1\",\"module-shop-order_field\\/edit\":\"1\",\"module-shop-order_field\\/delete\":\"1\",\"plugin-log-action\\/index\":\"1\",\"plugin-log-action\\/delete\":\"1\",\"plugin-log-login\\/index\":\"1\",\"plugin-log-login\\/delete\":\"1\",\"plugin-weixin-setting\\/index\":\"1\",\"plugin-weixin-menu\\/config\":\"1\",\"plugin-weixin-weixin_autoreply\\/index\":\"1\",\"plugin-weixin-weixin_autoreply\\/add\":\"1\",\"plugin-weixin-weixin_autoreply\\/edit\":\"1\",\"plugin-weixin-weixin_autoreply\\/delete\":\"1\",\"plugin-weixin-weixin_msg\\/index\":\"1\",\"plugin-config_set-config\\/index\":\"1\",\"plugin-config_set-config\\/add\":\"1\",\"plugin-config_set-config\\/edit\":\"1\",\"plugin-config_set-config\\/delete\":\"1\",\"plugin-config_set-group\\/index\":\"1\",\"plugin-config_set-group\\/add\":\"1\",\"plugin-config_set-group\\/edit\":\"1\",\"plugin-config_set-group\\/delete\":\"1\",\"plugin-smsali-setting\\/index\":\"1\",\"plugin-label-index\\/index\":\"1\",\"plugin-label-index\\/edit\":\"1\",\"plugin-label-index\\/delete\":\"1\",\"plugin-label-index\\/set\":\"1\",\"plugin-label-applabel\\/index\":\"1\",\"plugin-label-applabel\\/add\":\"1\",\"plugin-label-applabel\\/edit\":\"1\",\"plugin-label-applabel\\/delete\":\"1\",\"plugin-label-applabel\\/set\":\"1\",\"plugin-login-setting\\/index\":\"1\",\"plugin-comment-content\\/index\":\"1\",\"plugin-comment-content\\/delete\":\"1\",\"plugin-comment-setting\\/index\":\"1\",\"plugin-area-province\\/index\":\"1\",\"plugin-area-province\\/add\":\"1\",\"plugin-area-province\\/edit\":\"1\",\"plugin-area-province\\/delete\":\"1\",\"plugin-area-city\\/index\":\"1\",\"plugin-area-city\\/add\":\"1\",\"plugin-area-city\\/edit\":\"1\",\"plugin-area-city\\/delete\":\"1\",\"plugin-area-zone\\/index\":\"1\",\"plugin-area-zone\\/add\":\"1\",\"plugin-area-zone\\/edit\":\"1\",\"plugin-area-zone\\/delete\":\"1\",\"plugin-area-street\\/index\":\"1\",\"plugin-area-street\\/add\":\"1\",\"plugin-area-street\\/edit\":\"1\",\"plugin-area-street\\/delete\":\"1\",\"plugin-marketing-setting\\/index\":\"1\",\"plugin-marketing-setting\\/add\":\"1\",\"plugin-marketing-setting\\/edit\":\"1\",\"plugin-marketing-setting\\/delete\":\"1\",\"plugin-marketing-rmb_getout\\/index\":\"1\",\"plugin-marketing-rmb_getout\\/delete\":\"1\",\"plugin-marketing-rmb_getout\\/pay\":\"1\",\"plugin-marketing-rmb_getout\\/log\":\"1\",\"plugin-marketing-rmb_infull\\/index\":\"1\",\"plugin-marketing-rmb_infull\\/delete\":\"1\",\"plugin-marketing-rmb_consume\\/index\":\"1\",\"plugin-marketing-rmb_consume\\/delete\":\"1\",\"plugin-marketing-moneylog\\/index\":\"1\",\"plugin-marketing-moneylog\\/delete\":\"1\"},\"Submit\":\"\\u63d0\\u4ea4\",\"id\":\"3\"}');
INSERT INTO `qb_log_action` VALUES ('2','1','1542375690','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"473\",\"title\":\"\\u5fae\\u4fe1\\u5bf9\\u5916\\u8f6c\\u5e10cert\\u8bc1\\u4e66\",\"c_key\":\"weixin_apiclient_cert\",\"type\":\"4\",\"form_type\":\"file\",\"c_descrip\":\"\\u5546\\u5bb6\\u5bf9\\u5916\\u8f6c\\u5e10\\u63a5\\u53e3\\uff0c\\u6536\\u6b3e\\u7528\\u4e0d\\u5230\\uff0c\\u7559\\u7a7a\\u5c31\\u4e0d\\u80fd\\u5bf9\\u5916\\u8f6c\\u5e10\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('3','1','1542375690','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"473\",\"title\":\"\\u5fae\\u4fe1\\u5bf9\\u5916\\u8f6c\\u5e10cert\\u8bc1\\u4e66\",\"c_key\":\"weixin_apiclient_cert\",\"type\":\"4\",\"form_type\":\"file\",\"c_descrip\":\"\\u5546\\u5bb6\\u5bf9\\u5916\\u8f6c\\u5e10\\u63a5\\u53e3\\uff0c\\u6536\\u6b3e\\u7528\\u4e0d\\u5230\\uff0c\\u7559\\u7a7a\\u5c31\\u4e0d\\u80fd\\u5bf9\\u5916\\u8f6c\\u5e10\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('4','1','1542375700','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"474\",\"title\":\"\\u5fae\\u4fe1\\u5bf9\\u5916\\u8f6c\\u5e10key\\u8bc1\\u4e66\",\"c_key\":\"weixin_apiclient_key\",\"type\":\"4\",\"form_type\":\"file\",\"c_descrip\":\"\\u5546\\u5bb6\\u5bf9\\u5916\\u8f6c\\u5e10\\u63a5\\u53e3\\uff0c\\u6536\\u6b3e\\u7528\\u4e0d\\u5230\\uff0c\\u7559\\u7a7a\\u5c31\\u4e0d\\u80fd\\u5bf9\\u5916\\u8f6c\\u5e10\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('5','1','1542375700','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"474\",\"title\":\"\\u5fae\\u4fe1\\u5bf9\\u5916\\u8f6c\\u5e10key\\u8bc1\\u4e66\",\"c_key\":\"weixin_apiclient_key\",\"type\":\"4\",\"form_type\":\"file\",\"c_descrip\":\"\\u5546\\u5bb6\\u5bf9\\u5916\\u8f6c\\u5e10\\u63a5\\u53e3\\uff0c\\u6536\\u6b3e\\u7528\\u4e0d\\u5230\\uff0c\\u7559\\u7a7a\\u5c31\\u4e0d\\u80fd\\u5bf9\\u5916\\u8f6c\\u5e10\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('6','1','1542375728','127.0.0.1','admin','setting','index','','{\"group\":\"4\"}');
INSERT INTO `qb_log_action` VALUES ('7','1','1542375757','127.0.0.1','admin','setting','index','','{\"group\":\"1\",\"webname\":\"\\u9f50\\u535aX1.0\",\"seo_title\":\"\\u9f50\\u535a\\u8457\\u540d\\u7684\\u5f00\\u6e90\\u8f6f\\u4ef6\\u63d0\\u4f9b\\u5546\",\"web_open\":\"1\",\"style\":\"default\",\"wapstyle\":\"default\",\"member_style\":\"default\",\"member_wapstyle\":\"default\",\"admin_style\":\"default\",\"forbid_show_bug\":\"1\",\"upfileType\":\".rar .txt .jpg .gif .bmp .png .zip .mp3 .wma .wmv .mpeg .mpg .rm .ram .htm .doc .swf .avi .flv .sql ..\",\"close_why\":\"\\u7f51\\u7ad9\\u7ef4\\u62a4\\u5f53\\u4e2d,\\u6682\\u505c\\u8bbf\\u95ee.\",\"miibeian_gov_cn\":\"\\u4eacICP\\u5907050453\\u53f7\",\"MoneyName\":\"\\u91d1\\u5e01\",\"mymd5\":\"34d63833b520ea\",\"MoneyDW\":\"\\u5143\",\"group_expire_data\":\"365\",\"copyright\":\"\\u8054\\u7cfb\\u7535\\u8bdd:020-28998648 @\\u5e7f\\u5dde\\u9f50\\u535a\\u7f51\\u7edc\\u79d1\\u6280\\u6709\\u9650\\u516c\\u53f8\"}');
INSERT INTO `qb_log_action` VALUES ('8','1','1542375801','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"405\",\"title\":\"ICP\\u5907\\u6848\\u53f7\",\"c_key\":\"miibeian_gov_cn\",\"type\":\"1\",\"form_type\":\"text\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('9','1','1542375801','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"405\",\"title\":\"ICP\\u5907\\u6848\\u53f7\",\"c_key\":\"miibeian_gov_cn\",\"type\":\"1\",\"form_type\":\"text\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('10','1','1542375920','127.0.0.1','admin','plugin','execute','config_set/config/add','{\"title\":\"\\u516c\\u5b89\\u5907\\u6848\\u53f7\",\"c_key\":\"miibeian_gongan_gov_cn\",\"type\":\"1\",\"form_type\":\"text\",\"ifsys\":\"1\",\"group\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('11','1','1542375920','127.0.0.1','admin','plugin','execute','config_set/config/add','{\"title\":\"\\u516c\\u5b89\\u5907\\u6848\\u53f7\",\"c_key\":\"miibeian_gongan_gov_cn\",\"type\":\"1\",\"form_type\":\"text\",\"ifsys\":\"1\",\"group\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('12','1','1542375936','127.0.0.1','admin','plugin','execute','config_set/config/quickedit','{\"pk\":\"405\",\"name\":\"list\",\"value\":\"-2\"}');
INSERT INTO `qb_log_action` VALUES ('13','1','1542375936','127.0.0.1','admin','plugin','execute','config_set/config/quickedit','{\"pk\":\"405\",\"name\":\"list\",\"value\":\"-2\"}');
INSERT INTO `qb_log_action` VALUES ('14','1','1542375939','127.0.0.1','admin','plugin','execute','config_set/config/quickedit','{\"pk\":\"652\",\"name\":\"list\",\"value\":\"-3\"}');
INSERT INTO `qb_log_action` VALUES ('15','1','1542375939','127.0.0.1','admin','plugin','execute','config_set/config/quickedit','{\"pk\":\"652\",\"name\":\"list\",\"value\":\"-3\"}');
INSERT INTO `qb_log_action` VALUES ('16','1','1542375998','127.0.0.1','admin','setting','index','','{\"group\":\"1\",\"webname\":\"\\u9f50\\u535aX1.0\",\"seo_title\":\"\\u9f50\\u535a\\u8457\\u540d\\u7684\\u5f00\\u6e90\\u8f6f\\u4ef6\\u63d0\\u4f9b\\u5546\",\"web_open\":\"1\",\"style\":\"default\",\"wapstyle\":\"default\",\"member_style\":\"default\",\"member_wapstyle\":\"default\",\"admin_style\":\"default\",\"forbid_show_bug\":\"1\",\"upfileType\":\".rar .txt .jpg .gif .bmp .png .zip .mp3 .wma .wmv .mpeg .mpg .rm .ram .htm .doc .swf .avi .flv .sql ..\",\"close_why\":\"\\u7f51\\u7ad9\\u7ef4\\u62a4\\u5f53\\u4e2d,\\u6682\\u505c\\u8bbf\\u95ee.\",\"MoneyName\":\"\\u91d1\\u5e01\",\"mymd5\":\"34d63833b520ea\",\"MoneyDW\":\"\\u5143\",\"group_expire_data\":\"365\",\"copyright\":\"\\u8054\\u7cfb\\u7535\\u8bdd:020-28998648 @\\u5e7f\\u5dde\\u9f50\\u535a\\u7f51\\u7edc\\u79d1\\u6280\\u6709\\u9650\\u516c\\u53f8\",\"miibeian_gov_cn\":\"\\u4eacICP\\u5907050453\\u53f7\"}');
INSERT INTO `qb_log_action` VALUES ('17','1','1542376028','127.0.0.1','admin','setting','index','','{\"group\":\"8\",\"RegYz\":\"1\",\"emailOnly\":\"1\",\"regmoney\":\"1\",\"forbidRegName\":\"\\u7ba1\\u7406\\u5458\\r\\nadmin\",\"edit_username_money\":\"100\"}');
INSERT INTO `qb_log_action` VALUES ('18','1','1542376094','127.0.0.1','admin','webmenu','edit','','{\"name\":\"\\u4f1a\\u5458\\u4e2d\\u5fc3\",\"url\":\"\\/member.php\\/member\\/index.html\",\"type\":\"3\",\"ifshow\":\"1\",\"style\":\"si si-user\",\"activate\":\"member\",\"id\":\"29\"}');
INSERT INTO `qb_log_action` VALUES ('19','1','1542376103','127.0.0.1','admin','webmenu','edit','','{\"name\":\"\\u5708\\u5b50\\u5e7f\\u573a\",\"url\":\"\\/index.php\\/qun\\/index\\/index.html\",\"type\":\"3\",\"ifshow\":\"1\",\"list\":\"9\",\"style\":\"glyphicon glyphicon-bullhorn\",\"activate\":\"qun\",\"id\":\"27\"}');
INSERT INTO `qb_log_action` VALUES ('20','1','1542376291','127.0.0.1','admin','webmenu','edit','','{\"name\":\"\\u4e3b\\u9875\",\"url\":\"\\/index.php\",\"type\":\"3\",\"ifshow\":\"1\",\"list\":\"10\",\"style\":\"si si-home\",\"activate\":\"index\",\"id\":\"26\"}');
INSERT INTO `qb_log_action` VALUES ('21','1','1542376351','127.0.0.1','admin','webmenu','edit','','{\"name\":\"\\u8d44\\u8baf\",\"url\":\"\\/index.php\\/cms\\/\",\"type\":\"3\",\"ifshow\":\"1\",\"list\":\"8\",\"style\":\"fa fa-fw fa-rss-square\",\"activate\":\"cms\",\"id\":\"28\"}');
INSERT INTO `qb_log_action` VALUES ('22','1','1542376633','127.0.0.1','cms','field','index','','{\"orderdb\":{\"22\":\"100\",\"51\":\"98\",\"23\":\"90\",\"26\":\"80\",\"24\":\"-1\"},\"mid\":\"3\",\"Submit\":\"\\u4fee\\u6539\\u5b57\\u6bb5\\u6392\\u5e8f\"}');
INSERT INTO `qb_log_action` VALUES ('23','1','1542376681','127.0.0.1','shop','field','edit','','{\"title\":\"\\u989c\\u8272\",\"name\":\"type3\",\"type\":\"array\",\"field_type\":\"varchar(255) NOT NULL\",\"postdb\":{\"field_type\":\"\"},\"nav\":\"\\u5546\\u54c1\\u5c5e\\u6027\",\"Submit\":\"\\u63d0\\u4ea4\",\"id\":\"50\"}');
INSERT INTO `qb_log_login` VALUES ('1','1','127.0.0.1','1542375593','admin','7505b9c72ab4aa94b1a4ed7b207b67fb');
INSERT INTO `qb_memberdata` VALUES ('1','a6439d68dea86a61576310329d8abe72','ce6a5','admin','我是超管','','wf','','3','1','','1','186','0','8774571','1542375593','127.0.0.1','1542375586','127.0.0.1','1','1890-00-00','uploads/images/20180320/719d42cdf564010d411f2be85c5f47b9.jpeg','fdfdf','','bb@126.com','0','1','cvbnmmm','13399999999','','张学友','a:4:{s:7:\"endtime\";s:0:\"\";s:9:\"alipay_id\";s:6:\"666666\";s:4:\"bank\";s:114:\"62223333333333373 张三 中国工商银行北京**支行\n62284444444919 张三 中国农业银行北京***分行\";s:7:\"pay_pwd\";s:1:\"3\";}','0','0','0','77.90','359.00','e10adc3949ba59abbe56e057f20f883e','22','0','0','0','a:1:{s:6:\"RegMsg\";i:1;}');
INSERT INTO `qb_module` VALUES ('1','','','1','CMS模块','cms','','','0','','','1','0','','','fa fa-fw fa-file-text','0');
INSERT INTO `qb_module` VALUES ('2','','','1','商城','shop','','','-1','','','1','0','','','fa fa-shopping-bag','0');
INSERT INTO `qb_plugin` VALUES ('1','0','log','系统日志','fa fa-fw fa-info-circle','在后台首页显示服务器信息','','','','1.0.0','0','1477757503','1004','1','1','0');
INSERT INTO `qb_plugin` VALUES ('2','0','weixin','微信相关功能','fa fa-fw fa-comments','','','','','1.0.0','0','1477755780','1002','1','0','0');
INSERT INTO `qb_plugin` VALUES ('4','0','config_set','开发者功能','fa fa-fw fa-gears','','','','','','0','0','900','1','1','0');
INSERT INTO `qb_plugin` VALUES ('5','0','marketing','财务与积分功能','fa fa-fw fa-database','','','','','','0','0','100','1','1','0');
INSERT INTO `qb_plugin` VALUES ('6','0','alipay','支付宝接口','fa fa-fw fa-briefcase','','','','','','0','0','100','1','0','0');
INSERT INTO `qb_plugin` VALUES ('7','0','area','城市地区管理','fa fa-fw fa-flag','','','','','','0','0','100','1','1','0');
INSERT INTO `qb_plugin` VALUES ('8','0','comment','评论','fa fa-fw fa-bullhorn','','','','','','0','1517134278','100','1','0','0');
INSERT INTO `qb_plugin` VALUES ('9','0','login','第三方登录接口','fa fa-fw fa-handshake-o','','','','','','0','0','100','1','0','0');
INSERT INTO `qb_plugin` VALUES ('10','0','label','标签管理','fa fa-fw fa-sticky-note-o','','','','','','0','0','100','1','0','0');
INSERT INTO `qb_plugin` VALUES ('11','0','smsali','阿里云短信接口','si si-envelope-letter','','SuiFeng','http://www.php168.com','','1.0','0','0','100','1','1','0');
INSERT INTO `qb_shop_car` VALUES ('1','3','2','2','0','1','1527243313','1533041423','1','1');
INSERT INTO `qb_shop_car` VALUES ('3','3','3','2','0','1','1527555593','1527555593','1','3');
INSERT INTO `qb_shop_content` VALUES ('3','1','1');
INSERT INTO `qb_shop_content` VALUES ('2','1','1');
INSERT INTO `qb_shop_content1` VALUES ('3','1','2','魅族蓝牙小音箱','1','1','50','1','0','1517981293','1529664717','0','uploads/images/20180302/CnQOjVikE4qAYN55AAMAoDa-ghQ407.jpg','<p><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/01/1E/CnQOjVij_geANlzXAAJ4JdyIZ7g421.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/01/1E/Cix_s1ij_giAVoRwAALyOhoZT6k135.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/01/1E/Cix_s1ij_giAcddhAAIAdrNbQ5I909.jpg\"/></p>','100.22','0','0','0','0','0','[\"16G|32\",\"32G\",\"64G|45\"]','[\"红色\",\"白色\"]','[]','30','0','20','0.00');
INSERT INTO `qb_shop_content1` VALUES ('2','1','1','魅族手机M9最新款隆重上市了','1','1','245','1','0','1516259334','1529664714','0','uploads/images/20180302/Cgbj0FnCGy2AQhMOAA5ZxbK1GIo722.jpg','<p><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/1E/Cgbj0VrcdgOAf_cEAAHV1O1wNn4780.jpg\"/><a href=\"https://detail.meizu.com/item/spx.html\" target=\"_blank\"><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/03/86/Cgbj0FqzftuAFRuEAAFDN8UQ57I852.jpg\"/></a><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/10/Cgbj0FrcdgOADH3rAAJvD1XrMDg850.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/1E/Cgbj0VrcdgOAV3G7AAVRP964D3A280.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/10/Cgbj0FrcdgWAbRd5AAFG0cWJKug303.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/10/Cgbj0FrcdgWAZNLyAAHNcu8f9V8672.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/1E/Cgbj0VrcdgWAMuu2AAVk0BJBeg4924.jpg\"/><img class=\"lazy\" width=\"1240\" alt=\"\" src=\"https://openfile.meizu.com/group1/M00/04/1E/Cgbj0VrcdgaAPMMqAAJ5D3ohZpM015.jpg\"/></p>','2020.02','0','0','0','0','0','[\"大份|10\",\"中份|20\",\"小份|40\"]','[\"XX\",\"XL\",\"XXXL\"]','[\"红\",\"黄\",\"蓝\"]','30','0','20','0.00');
INSERT INTO `qb_shop_field` VALUES ('10','title','商品名称','text','varchar(256) NOT NULL','','','','0','1','','','','','','2','','','','100','1','1','1','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('11','picurl','商品介绍图','images','text NOT NULL','','','','0','1','','','','','','2','','','','98','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('12','content','商品介绍','ueditor','text NOT NULL','','','','0','1','','','','','','2','','','','0','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('47','price','商品价格','money','decimal(10, 2 ) UNSIGNED NOT NULL','','','','0','1','','','','','','2','','','','99','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('48','type1','型号','array','varchar(255) NOT NULL','','','只有这一项可以定义价格,属性|价格用竖线隔开,比如:大份|20','0','1','','','','','','2','','','','0','0','0','0','商品属性','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('49','type2','尺寸','array','varchar(255) NOT NULL','','','','0','1','','','','','','2','','','','0','0','0','0','商品属性','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('50','type3','颜色','array','varchar(255) NOT NULL','','','','0','1','','','','','','2','','','','0','0','0','0','商品属性','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('52','linkman','联系人','text','varchar(60) NOT NULL','','','','1','-1','','','','','','2','','','','10','1','1','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('53','telphone','联系电话','text','varchar(60) NOT NULL','','','','1','-1','','','','','','2','','','','9','1','1','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('54','address','联系地址','text','varchar(256) NOT NULL','','','','1','-1','','','','','','2','','','','8','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('55','user_note','附注留言','textarea','text NOT NULL','','','','1','-1','','','','','','2','','','','0','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('59','myfid','我的分类','select','int(7) NOT NULL DEFAULT \'0\'','','shop_mysort@id,name@uid','<script>if($(\"#atc_myfid\").children().length<1)$(\"#form_group_myfid\").remove();</script>','1','1','','','','','','2','','','','1','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('60','market_price','市场原价','money','decimal(10,2) unsigned NOT NULL','','','','1','1','','','','','','2','','','','99','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_field` VALUES ('61','num','库存量','number','mediumint(7) NOT NULL DEFAULT \'0\'','500','','','1','1','','','','','','2','','','','97','0','0','0','','','','','','','','');
INSERT INTO `qb_shop_module` VALUES ('1','','商品模型','','','100','1515221331','0');
INSERT INTO `qb_shop_sort` VALUES ('1','0','1','数码产品','0','','','','','','','');
INSERT INTO `qb_shop_sort` VALUES ('2','0','1','家居用品','0','','','','','','','');
INSERT INTO `qb_webmenu` VALUES ('1','0','1','网上商城','/index.php/shop/','0','1','100','','shop');
INSERT INTO `qb_webmenu` VALUES ('24','0','1','图片专栏','/index.php/cms/list-14.html','0','1','0','','cms-14');
INSERT INTO `qb_webmenu` VALUES ('23','0','1','娱乐新闻','/index.php/cms/list-9.html','0','1','10','','cms-9');
INSERT INTO `qb_webmenu` VALUES ('22','0','1','联系我们','/index.php/page/8.html','0','1','0','','index-alonepage8');
INSERT INTO `qb_webmenu` VALUES ('18','0','1','新闻资讯','/index.php/cms/','0','1','11','','cms-');
INSERT INTO `qb_webmenu` VALUES ('21','0','1','网站首页','/index.php','0','1','101','','index-');
INSERT INTO `qb_webmenu` VALUES ('26','0','3','主页','/index.php','0','1','10','si si-home','index');
INSERT INTO `qb_webmenu` VALUES ('27','0','3','圈子广场','/index.php/qun/index/index.html','0','1','9','glyphicon glyphicon-bullhorn','qun');
INSERT INTO `qb_webmenu` VALUES ('28','0','3','资讯','/index.php/cms/','0','1','8','fa fa-fw fa-rss-square','cms');
INSERT INTO `qb_webmenu` VALUES ('29','0','3','会员中心','/member.php/member/index.html','0','1','0','si si-user','member');
INSERT INTO `qb_webmenu` VALUES ('30','0','2','网站首页','/index.php','0','1','0','','');
