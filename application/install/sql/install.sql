...
CREATE TABLE `qb_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户收货地址';
...
CREATE TABLE `qb_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='管理员常用菜单';
...
CREATE TABLE `qb_cms_content` (
  ...
  KEY `mid` (`mid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='内容索引表';
...
CREATE TABLE `qb_cms_sort` (
  ...
  KEY `pid` (`pid`),
  KEY `list` (`list`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='主栏目表';
...
CREATE TABLE `qb_config` (
  ...
  KEY `sys_type` (`sys_id`),
  KEY `c_key` (`c_key`)
) ENGINE=MyISAM AUTO_INCREMENT=631 DEFAULT CHARSET=utf8 COMMENT='系统参数配置';
...
CREATE TABLE `qb_config_group` (
  ...
  KEY `ifsys` (`ifsys`),
  KEY `ifshow` (`ifshow`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='参数配置分组分类';
...
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='接口(钩子)列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='۳̨әطɕ־';
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='ԃۧև¼ɕ־';
...
CREATE TABLE `qb_plugin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='插件列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='购物车';
...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='商品订单';
...
INSERT INTO `qb_address` VALUES ('1','5','张三69999','0','13654545454','市桥103号3','','0');
INSERT INTO `qb_address` VALUES ('2','5','李四88','0','18698545212','天河区123号','','1');
...
INSERT INTO `qb_area` VALUES ('1','0','全省','1','0','','');
INSERT INTO `qb_area` VALUES ('2','0','广东','0','10','','');
INSERT INTO `qb_area` VALUES ('4','0','湖南省','0','0','','');
INSERT INTO `qb_area` VALUES ('5','0','湖南省','0','0','','');
...
INSERT INTO `qb_cms_sort` VALUES ('9','0','1','娱乐新闻','0','','','','','0','0','0');
INSERT INTO `qb_cms_sort` VALUES ('10','9','1','香港娱乐新闻','0','','','','','0','0','0');
INSERT INTO `qb_cms_sort` VALUES ('11','9','1','大陆娱乐新闻','0','','','','','0','0','0');
INSERT INTO `qb_cms_sort` VALUES ('12','11','1','广东娱乐','0','','','','','0','0','0');
INSERT INTO `qb_cms_sort` VALUES ('13','0','2','黄山风景','0','','','','','0','0','0');
INSERT INTO `qb_cms_sort` VALUES ('14','13','2','光明顶','0','','','','','0','0','0');
...
INSERT INTO `qb_config` VALUES ('142','20','QQ登录接口密钥','qqlogin_appsecret','','text','','1','','','0','-9');
...
1|自动审核','1','','','98','0');
INSERT INTO `qb_config` VALUES ('228','3','邮箱端口','MailPort','','text','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('229','3','邮箱接口帐号','MailId','','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('232','8','注册需要验证码','yzImgReg','1','radio','0|不需要
1|需要','1','','','99','0');
INSERT INTO `qb_config` VALUES ('246','3','邮箱接口密码','MailPw','','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('251','3','邮箱服务器IP或域名','MailServer','smtp.163.com','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('256','1','网站是否开放','web_open','1','radio','0|关闭
1|开放','1','','','100','0');
INSERT INTO `qb_config` VALUES ('266','8','注册可得多少积分','regmoney','5','','','1','','','96','0');
INSERT INTO `qb_config` VALUES ('269','8','禁止注册的用户名','forbidRegName','admin','textarea','','1','','每个换一行','0','0');
...
INSERT INTO `qb_config` VALUES ('311','1','会员中心风格','member_style','default','select','app\\common\\util\\Style@listMemberStyle','1','','','0','0');
...
INSERT INTO `qb_config` VALUES ('339','4','微信公众号TOKEN','weixin_token','','text','','1','','微信服务器地址(URL)那里输入的网址是 https://你的域名/index.php/index/plugin/execute/plugin_name/weixin/plugin_controller/api/plugin_action/index.html','98','-2');
...
INSERT INTO `qb_config` VALUES ('433','1','站点加密字符串','mymd5','9b7cf7623ce015','text','','1','','设置后就不要随意修改，不然会影响到之前的数据','0','0');
...
INSERT INTO `qb_memberdata` VALUES ('1','admin','我是牛人','','wf','','3','1','','1','186','8774571','1513820567','127.0.0.1','1524650509','127.0.0.1','1','1890-00-00','uploads/images/20180320/719d42cdf564010d411f2be85c5f47b9.jpeg','fdfdf','','bb@126.com','0','1','cvbnmmm','13399999999','','张学友','a:4:{s:7:\"endtime\";s:0:\"\";s:9:\"alipay_id\";s:6:\"666666\";s:4:\"bank\";s:114:\"62223333333333373 张三 中国工商银行北京**支行
...
INSERT INTO `qb_module` VALUES ('1','','','1','CMS模块','cms','','','0','','','1','0','','','fa fa-fw fa-file-text');
INSERT INTO `qb_module` VALUES ('2','','','1','商城','shop','','','-1','','','1','0','','','fa fa-shopping-bag');
INSERT INTO `qb_plugin` VALUES ('1','0','log','系统日志','fa fa-fw fa-info-circle','在后台首页显示服务器信息','','','','1.0.0','0','1477757503','1004','1','1');
INSERT INTO `qb_plugin` VALUES ('2','0','weixin','微信相关功能','fa fa-fw fa-comments','','','','','1.0.0','0','1477755780','1002','1','0');
INSERT INTO `qb_plugin` VALUES ('4','0','config_set','开发者功能','fa fa-fw fa-gears','','','','','','0','0','900','1','1');
INSERT INTO `qb_plugin` VALUES ('5','0','marketing','营销功能','fa fa-fw fa-users','','','','','','0','0','100','1','1');
INSERT INTO `qb_plugin` VALUES ('6','0','alipay','支付宝接口','fa fa-fw fa-briefcase','','','','','','0','0','100','1','0');
INSERT INTO `qb_plugin` VALUES ('7','0','area','城市地区管理','fa fa-fw fa-flag','','','','','','0','0','100','1','1');
INSERT INTO `qb_plugin` VALUES ('8','0','comment','评论','fa fa-fw fa-bullhorn','','','','','','0','1517134278','100','1','0');
INSERT INTO `qb_plugin` VALUES ('9','0','login','第三方登录接口','fa fa-fw fa-handshake-o','','','','','','0','0','100','1','0');
INSERT INTO `qb_plugin` VALUES ('10','0','label','标签管理','fa fa-fw fa-sticky-note-o','','','','','','0','0','100','1','0');
INSERT INTO `qb_shop_car` VALUES ('1','3','3','1','0','8','1521779315','1521780887','1','5');
INSERT INTO `qb_shop_content` VALUES ('3','1','1');
INSERT INTO `qb_shop_content` VALUES ('2','1','1');
INSERT INTO `qb_shop_content1` VALUES ('3','1','1','魅族手机M9最新款','1','1','22','1','0','1517981293','1523952575','0','uploads/images/20180208/c30043460273133c77ddb0ccc93d7f9d.jpg','<p>这是手机哦</p>','10.22','0','0','0','0','0','[\"16G|32\",\"32G\",\"64G|45\"]','[\"红色\",\"白色\"]','[]','30');
INSERT INTO `qb_shop_content1` VALUES ('2','1','1','裤子最新款','1','1','233','1','0','1516259334','1524563488','0','uploads/images/20180315/bde984aaef393d496a50d3847282f7b5.jpg','<p>王猛不避讳自己性格的“弱点”：“内向，敏感，不善交际”。他认为，这正与父母有关，“我母亲一直倾向于把我关在家里，按自己的喜好包办事情。”</p><p>王猛至今记忆深刻的一件事发生在小学一二年级——班里文艺演出要求穿齐膝短裤。“母亲却不由分说让我穿长裤，我提出带上短裤备用也没被准许。”王猛说，从小到大几乎所有的衣服都是按照父母的意愿和审美来置办的，几乎没有一次是按照自己的意愿来进行选择的。</p><p>王猛五六年级时，对奥数很有感觉，一开始母亲并不乐意让他去。有次参加奥数考试，携带的文件夹不见了，找回后发现被划坏并涂抹，“回到家后，母亲不但没有安慰我，反而说‘这下你知道外面的世界很精彩了吧’！”</p><p>高中毕业前，所有的社交圈子几乎都在生活的大院里，“朋友，都是父母认识、了解或者听过的”。高中时，王猛曾强烈要求到外面的学校上学，但遭到父母的拒绝。尽管后来考上北大，也因社交障碍很难与人交往。</p><p><br/></p>','20.02','0','0','0','0','0','[\"大份|10\",\"中份|20\",\"小份|40\"]','[\"XX\",\"XL\",\"XXXL\"]','[\"红\",\"黄\",\"蓝\"]','30');
...
INSERT INTO `qb_shop_sort` VALUES ('1','0','1','数码产品','0','','','','','0','0','0');
INSERT INTO `qb_shop_sort` VALUES ('2','0','1','家居用品','0','','','','','0','0','0');
INSERT INTO `qb_webmenu` VALUES ('1','0','1','网上商城','/index.php/shop/','0','1','100','','shop');
INSERT INTO `qb_webmenu` VALUES ('24','0','1','数码产品','/index.php/shop/content/index/fid/1.html','0','1','0','','');
INSERT INTO `qb_webmenu` VALUES ('23','0','1','娱乐新闻','/index.php/cms/content/index/fid/9.html','0','1','0','','');
INSERT INTO `qb_webmenu` VALUES ('22','0','1','企业相册','/index.php/cms/content/index/fid/14.html','0','1','0','','');
INSERT INTO `qb_webmenu` VALUES ('18','0','1','新闻资讯','/index.php/cms/','0','1','11','','news');
