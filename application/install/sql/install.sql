...
INSERT INTO `qb_admin_menu` (`id`, `pid`, `type`, `name`, `url`, `target`, `ifshow`, `list`, `style`, `groupid`, `tier`, `icon`) VALUES
(1, 0, 0, '基础功能设置', '', 0, 1, 100, '', 3, 0, 'fa fa-fw fa-gear'),
(2, 1, 0, '网站参数设置', '/admin.php/admin/setting/index.html', 0, 1, 0, '', 3, 0, ''),
(3, 1, 0, '网站菜单设置', '/admin.php/admin/webmenu/index.html', 0, 1, 0, '', 3, 0, ''),
(4, 0, 0, '用户与权限设置', '', 0, 1, 0, '', 3, 0, 'fa fa-fw fa-user'),
...
INSERT INTO `qb_alonepage` (`id`, `name`, `title`, `posttime`, `template`, `filename`, `descrip`, `keywords`, `content`, `view`, `ifclose`, `picurl`, `list`) VALUES
(8, '欢迎关注官方微信', '欢迎关注公众号', 1447747983, '', 'do/weixin.htm', '', '', '<p style="text-align:center;"><br/></p><p>亲爱的会员，</p><p>&nbsp; 本站会员微信官方账号现已开通，您可以通过“扫一扫”功能或查找公众号中输入“齐博软件”即可添加。最新、最热的活动资讯将第一时间通知到您！</p><p><br/></p><p style="text-align:center;"><img src="http://bbs.qibosoft.com/attachment123456br666vh00/Day_140402/10312_243423_d93579d4987ee55.jpg" width="430" height="430"/><br/></p>', 28, 0, '', 0);
...
INSERT INTO `qb_area` (`id`, `pid`, `name`, `level`, `list`, `logo`, `content`) VALUES
(1, 0, '全省', 1, 0, '', ''),
(2, 0, '广东', 0, 10, '', ''),
(4, 0, '湖南省', 0, 0, '', ''),
(5, 0, '湖南省', 0, 0, '', '');
...
INSERT INTO `qb_config` (`id`, `type`, `title`, `c_key`, `c_value`, `form_type`, `options`, `ifsys`, `htmlcode`, `c_descrip`, `list`, `sys_id`) VALUES
(29, 2, '是否对图片加水印', 'is_waterimg', '2', 'radio', '1|启用\n2|禁用', 1, '', '', 0, 0),
(62, 8, '是否允许重复的邮箱', 'emailOnly', '1', 'radio', '0|允许重复\r\n1|不允许重复', 1, '', '', 97, 0),
(81, 0, '论坛接口数据表前缀', 'passport_pre', '`bbs`.pw_', '', '', 1, '', '', 0, 0),
(82, 0, '是否整合论坛', 'passport_type', '', 'text', '', 1, '', '', 0, 0),
(89, 20, 'QQ登录接口ID', 'qqlogin_appid', '', 'text', '', 1, '', '', 0, -9),
(142, 20, 'QQ登录接口密钥', 'qqlogin_appsecret', '', 'text', '', 1, '', '网站回调域是:    http://你的域名/index.php/p/login-qq-index.html;http://你的域名/p/login-qq-index.html', 0, -9),
(143, 7, '是否启用QQ登录', 'QQ_login', '0', '', '', 1, '', '', 0, 0),
(163, 1, '网站风格', 'style', 'default', 'select', 'app\\common\\util\\Style@listStyle', 1, '', '', 99, 0),
(172, 1, 'COOKIE前缀', 'cookiePre', '', '', '', 1, '', '安装多份系统才面要，默认留空', 0, 0),
(174, 2, '水印图片地址', 'waterimg', '', 'image', '', 1, '', '最好是透明的PNG图', 0, 0),
(175, 2, '是否启用GD库', 'if_gdimg', '0', 'radio', '1|启用\n0|禁用', 1, '', '可以对大图进行缩小/截取缩略图', 0, 0),
(196, 8, '手工注册是否自动通过审核', 'RegYz', '1', 'radio', '0|人工审核\r\n1|自动审核', 1, '', '', 98, 0),
(228, 3, '邮箱端口', 'MailPort', '465', 'text', '', 1, '', 'QQ邮箱端口是465,很多邮箱已经不支持25端口了', 0, 0),
(229, 3, '邮箱接口帐号', 'MailId', '', 'text', '', 1, '', '推荐用QQ邮箱', 0, 0),
(232, 8, '注册需要验证码', 'yzImgReg', '0', 'radio', '0|不需要\r\n1|需要', 1, '', '', 105, 0),
(246, 3, '邮箱接口密码', 'MailPw', '', 'text', '', 1, '', 'QQ邮箱不是真实登录密码,而是另外的一个KEY', 0, 0),
(251, 3, '邮箱服务器IP或域名', 'MailServer', 'smtp.qq.com', 'text', '', 1, '', 'QQ普通邮箱smtp.qq.com 而QQ域名邮箱是smtp.exmail.qq.com', 0, 0),
(256, 1, '网站是否开放', 'web_open', '1', 'radio', '0|关闭\n1|开放', 1, '', '', 100, 0),
(266, 8, '注册可得多少积分', 'regmoney', '5', 'number', '', 1, '', '', 96, 0),
(269, 8, '禁止注册的用户名', 'forbidRegName', '管理员\r\nadmin', 'textarea', '', 1, '', '每个换一行', 0, 0),
(271, 8, '是否关闭手工注册', 'forbid_normal_reg', '0', 'radio', '0|开放\r\n1|关闭', 1, '', '', 110, 0),
(299, 1, '版权信息', 'copyright', '联系电话:020-28998648 @广州齐博网络科技有限公司', 'textarea', '', 1, '', '', -1, 0),
(300, 1, '百度地图KEY', 'baidu_map_key', '', '', '', 1, '', '', 0, 0),
(302, 1, 'COOKIE域名', 'cookieDomain', '', '', '', 1, '', '', 0, 0),
(303, 1, '是否关闭网站调试', 'forbid_show_bug', '1', 'radio', '0|调试 还没上线\n1|关闭调试 正式运营', 1, '', '', 0, 0),
...
(321, 1, '站点SEO描述', 'seo_description', '', 'text', '', 1, '', '', 997, 0),
(323, 1, '网站名称', 'webname', '齐博X1.0', 'text', '', 1, '', '', 1000, 0),
(333, 2, '图片水印透明度', 'waterAlpha', '62', 'range', '', 1, '', '请输入数值，80代表80%', 0, 0),
(335, 4, '微信公众号AppSecret（应用密钥）', 'weixin_appsecret', '', 'text', '', 1, '', '', 99, 0),
(339, 4, '微信公众号TOKEN', 'weixin_token', '', 'text', '', 1, '', '微信服务器地址(URL)那里输入的网址是 http://你的域名/p/weixin-api-index.html', 98, -2),
(340, 11, 'PC版支付宝交易安全校验码（key）', 'alipay_key', '', 'text', '', 1, '', '', 87, 0),
(347, 12, '新用户关注微信时回复的纯文本内容', 'weixin_welcome', '', 'text', '', 1, '', '下面4项填写了，这一项就无效', 100, 0),
(348, 12, '新用户关注微信时图文标题', 'weixin_welcome_title', '感谢你关注齐博微信营销系统！', 'text', '', 1, '', '', 99, 0),
(349, 2, '水印位置', 'waterpos', '9', 'radio', '0|随机\n1|图片顶部左边\n2|图片顶部中间\n3|图片顶部右边\n4|图片中部左边\n5|图片中部中间\n6|图片中部右边\n7|图片底部左边\n8|图片底部中间\n9|图片底部右边', 1, '', '', 0, 0),
(350, 12, '回答不上的问题', 'weixin_problem', '请稍候，商家晚点会回复你的问题！', 'textarea', '', 1, '', '', 0, 0),
(351, 12, '新关注微信发送的图片', 'weixin_welcome_pic', '', 'image', '', 1, '', '', 98, 0),
(352, 12, '客服人员', 'weixin_reply_kefu', '', 'text', '', 1, '', '请输入客服的UID数字值，每个用空格隔开，留空则是管理员做客服', 70, 0),
(353, 12, '微信客服回复标志', 'weixin_reply_Tag', ' ', 'text', '', 1, '', '比如你可以设置在文字的前面输入一个空格即代表回复最近那个用户的信息，两个空格就回复倒数第二个用户咨询的信息', 69, 0),
(354, 12, '微信客户离开多久算离线', 'weixin_reply_Time', '1', 'number', '', 1, '', '单位小时（默认是1小时）', 68, 0),
(355, 5, '插件评论', 'Commend2CodeImgRegJF', '101', 'text', '', 1, '', '', 0, 0),
(365, 4, '微信公众号AppID（应用ID）', 'weixin_appid', '', 'text', '', 1, '', '', 100, 0),
...
(442, 11, 'PC版支付宝合作者身份', 'alipay_partner', '', 'text', '', 1, '', '合作身份者id，以2088开头的16位纯数字', 88, 0),
(444, 1, '网站SEO标题', 'seo_title', '齐博著名的开源软件提供商', 'text', '', 1, '', '', 999, 0),
(447, 6, '模块红包', 'RegHongBao', '0.100', 'text', '', 1, '', '', 0, 0),
(451, 13, '微信公众号二维码图片', 'weixin_code_img', 'http://www.wxyxpt.com/upload_files/web1/wenxin_center/49b_1_20160923120948_nu45d.jpg', 'image', '', 1, '', '', 0, -2),
(466, 1, '积分单位', 'MoneyDW', '元', '', '', 1, '', '', 0, 0),
(467, 11, 'PC版支付宝接口类型', 'alipay_service', 'create_direct_pay_by_user', 'radio', 'create_direct_pay_by_user|即时到账\ncreate_partner_trade_by_buyer|纯担保交易\ntrade_create_by_buyer|标准实物\n', 1, '', '推荐第一项', 86, 0),
(468, 11, 'wap版支付宝接口收款帐号', 'wap_ali_id', '', 'text', '', 1, '', '', 99, 0),
(473, 4, '微信对外转帐apiclient_cert证书', 'weixin_apiclient_cert', '', 'file', '', 1, '', '商家对外转帐接口，收款用不到，留空就不能对外转帐', 0, 0),
(474, 4, '微信对外转帐apiclient_key证书', 'weixin_apiclient_key', '', 'file', '', 1, '', '商家对外转帐接口，收款用不到，留空就不能对外转帐', 0, 0),
(475, 4, '微信对外转帐rootca证书', 'weixin_rootca', '', 'file', '', 1, '', '商家对外转帐接口，收款用不到，留空就不能对外转帐', 0, 0),
(476, 6, '地要', 'reg_group00', '', 'text', '', 1, '', '', 0, 0),
(477, 4, '微信支付接口MCHID（商户号）', 'weixin_payid', '', 'text', '', 1, '', '认证服务号才有的微信支付功能，留空就不能收款，填写后，才能在线收款，微信接口设置的支付授权目录是 https://你的域名/index.php/index/pay/index.html', 80, -2),
(478, 12, '新用户关注微信时图文链接', 'weixin_welcome_link', '', 'text', '', 1, '', '', 97, 0),
(479, 12, '新用户关注微信时图文描述', 'weixin_welcome_desc', '', 'textarea', '', 1, '', '', 96, 0),
(481, 4, '公众号类型', 'weixin_type', '0', 'radio', '0|没有对接公众号\n-1|未认证的订阅号\n1|未认证的服务号\n2|认证订阅号\n3|认证服务号', 1, '', '', 101, 0),
(482, 1, '购买用户组有效天数', 'group_expire_data', '365', 'number', '', 1, '', '', 0, 0),
(483, 14, 'SEO标题', 'mseo_title', '', 'text', '', 0, '', '', 100, 1),
(484, 14, 'SEO优化关键字keywords', 'mseo_keyword', '', 'text', '', 0, '', '', 99, 1),
(485, 17, '客服邮箱', 'service_email', '', 'text', '', 1, '', '', 0, 0),
(486, 17, '联系电话', 'service_tel', '020-28998648', 'text', '', 1, '', '', 0, 0),
(487, 17, '客服QQ', 'service_qq', '', 'text', '', 1, '', '', 0, 0),
(488, 17, '微信二维码', 'service_wxcode', '', 'image', '', 1, '', '', 0, 0),
(490, 4, '微信企业帐户可用余额', 'weixinTotalMoney', '', 'text', '', 1, '', '填写的数值小于或等于企业帐户里的可用余额，当数值小于1时，系统将无法给会员微信付款', 0, -2),
(496, 1, '登录后台是否启用验证码', 'admin_login_usercode', '0', 'radio', '0|不启用\n1|启用', 1, '', '', 0, 0),
(497, 14, 'SEO优化描述description', 'mseo_description', '', 'text', '', 0, '', '', 98, 1),
(498, 14, '是否开启当前模块', 'is_open_modlue', '1', 'radio', '1|开启\n0|关闭', 0, '', '', 97, 1),
(499, 14, '允许发布内容的用户组', 'can_post_group', '', 'checkbox', 'app\\common\\model\\Group@getTitleList@[{"id":["<>",2]}]', 0, '', '', 96, 1),
(500, 14, '发布内容自动通过审核的用户组', 'post_auto_pass_group', '', 'checkbox', 'app\\common\\model\\Group@getTitleList@[{"id":["<>",2]}]', 0, '', '', 95, 1),
(503, 14, '内容被设为精华奖励积分个数', 'com_info_add_money', '', 'text', '', 0, '', '', 94, 1),
(505, 16, 'SEO标题', 'mseo_title', '', 'text', '', 0, '', '', 100, 2),
(506, 16, 'SEO优化关键字keywords', 'mseo_keyword', '', 'text', '', 0, '', '', 99, 2),
(507, 16, 'SEO优化描述description', 'mseo_description', '', 'text', '', 0, '', '', 98, 2),
(508, 16, '是否开启当前模块', 'is_open_modlue', '1', 'radio', '1|开启\n0|关闭', 0, '', '', 97, 2),
(509, 16, '允许发布商品的用户组', 'can_post_group', '', 'checkbox', 'app\\common\\model\\Group@getTitleList@[{"id":["<>",2]}]', 0, '', '', 96, 2),
(510, 16, '发布商品自动通过审核的用户组', 'post_auto_pass_group', '', 'checkbox', 'app\\common\\model\\Group@getTitleList@[{"id":["<>",2]}]', 0, '', '', 95, 2),
(515, 16, '是否允许删除已付款商品订单', 'can_del_ispay_order', '', 'radio', '1|允许\n0|不允许', 0, '', '', 94, 2),
(516, 16, '客户下单是否短消息通知商家', 'post_order_msg_hy', '', 'radio', '1|通知\n0|不通知', 0, '', '', 93, 2),
(517, 16, '客户下单是否短信通知商家', 'post_order_sms_hy', '', 'radio', '1|通知\n0|不通知', 0, '', '', 92, 2),
(518, 16, '客户下单是否微信通知商家', 'post_order_wx_hy', '', 'radio', '1|通知\n0|不通知', 0, '', '', 91, 2),
(519, 16, '客户付款成功是否短消息通知商家', 'pay_order_msg_hy ', '', 'radio', '1|通知\n0|不通知', 0, '', '', 90, 2),
(520, 16, '客户付款成功是否短信通知商家', 'pay_order_sms_hy ', '', 'radio', '1|通知\n0|不通知', 0, '', '', 89, 2),
(521, 16, '客户付款成功是否微信通知商家', 'pay_order_wx_hy', '', 'radio', '1|通知\n0|不通知', 0, '', '', 88, 2),
(522, 16, '是否启用会员帐户余额付款', 'can_user_rmb_pay', '', 'radio', '1|启用\n0|关闭', 0, '', '', 87, 2),
(523, 4, '小程序AppID', 'wxapp_appid', '', 'text', '', 1, '', '', 151, -2),
(524, 4, '小程序密钥', 'wxapp_appsecret', '', 'text', '', 1, '', '', 150, -2),
(535, 4, '小程序支付接口（商户号）', 'wxapp_payid', '', 'text', '', 1, '', '', 149, -2),
(536, 4, '小程序支付接口KEY（商户API密钥）', 'wxapp_paykey', '', 'text', '', 1, '', '', 148, -2),
(557, 1, '是否定义频道当作默认主页', 'set_module_index', '0', 'select', 'app\\common\\util\\Module@getTitleList@{"title":"不使用频道做主页","type":"keywords"}', 1, '', '', 0, 0),
(616, 1, '网站LOGO', 'logo', '', 'image', '', 1, '', '', 0, 0),
(631, 1, '是否隐藏前台网址中的index.php文件名', 'hiden_index_php', '0', 'radio', '0|显示\r\n1|隐藏', 1, '', '如果空间不支持,就选择显示,不然前台页面会无法打开', 0, 0),
(632, 31, '阿里云短信模板', 'sms_template', '', 'text', '', 1, '', '模板中使用的变量只能是code,如果不是的话,请先修改或者重新申请一个把变量名换用code', 7, -11),
(633, 31, '阿里云短信签名', 'sms_sign_name', '', 'text', '', 1, '', '', 8, -11),
(634, 31, '阿里云短信接口密钥', 'sms_access_key', '', 'text', '', 1, '', '即AccessKeySecret', 9, -11),
...
INSERT INTO `qb_config_group` (`id`, `title`, `list`, `sys_id`, `ifshow`, `ifsys`) VALUES
(1, '基础设置', 999, 0, 1, 1),
(2, '水印设置', 993, 0, 1, 0),
(3, '邮箱接口设置', 994, 0, 1, 0),
(4, '微信接口', 998, -2, 1, 1),
...
INSERT INTO `qb_group` (`id`, `type`, `title`, `level`, `powerdb`, `allowadmin`, `admindb`) VALUES
...
INSERT INTO `qb_hook` (`id`, `name`, `about`, `ifopen`, `list`) VALUES
(1, 'user_add_begin', '新增(注册)用户之前', 1, 0),
(2, 'user_add_end', '新增(注册)用户之后', 1, 0),
(3, 'user_edit_begin', '用户修改信息之前', 1, 0),
(4, 'user_edit_end', '用户修改信息之后', 1, 0),
(5, 'user_delete_begin', '删除用户之前', 1, 0),
(6, 'user_delete_end', '删除用户之后', 1, 0),
(7, 'upfile_begin', '上传文件之前', 1, 0),
(8, 'upfile_end', '上传文件之后', 1, 0),
(9, 'cms_add_begin', '新发表信息之前', 1, 0),
(10, 'cms_add_end', '新发表信息之后', 1, 0),
(11, 'cms_edit_begin', '修改信息之前', 1, 0),
(12, 'cms_edit_end', '修改信息之后', 1, 0),
(13, 'cms_delete_begin', '删除信息之前', 1, 0),
(14, 'cms_delete_end', '删除信息之后', 1, 0),
...
INSERT INTO `qb_webmenu` (`id`, `pid`, `type`, `name`, `url`, `target`, `ifshow`, `list`, `style`, `activate`) VALUES
...
(27, 0, 3, '圈子广场', '/index.php/qun/index/index.html', 0, 1, 9, 'glyphicon glyphicon-bullhorn', ''),
(28, 0, 3, '创建圈子', '/index.php/qun/content/add.html', 0, 1, 8, 'glyphicon glyphicon-plus', ''),
(29, 0, 3, '会员中心', '/member.php/member/index.html', 0, 1, 0, 'si si-user', ''),
(30, 0, 2, '网站首页', '/index.php', 0, 1, 0, '', '');
...
INSERT INTO `qb_weixinmenu` (`id`, `uid`, `fid`, `name`, `keyword`, `linkurl`, `type`, `hide`, `list`) VALUES
(1, 0, 0, '菜单一', '', 'http://www.php168.com', 0, 0, 0),
(2, 0, 0, '菜单二', '', 'http://www.php168.com', 0, 0, 0),
(3, 0, 0, '菜单三', '', 'http://www.php168.com', 0, 0, 0),
(4, 0, 1, '子菜单', '', 'http://www.php168.com', 0, 0, 0);
...
INSERT INTO `qb_weixinword` (`id`, `ask`, `answer`, `list`, `type`) VALUES
(2, '价格', '门户系统价格分别是6800元、9500元，分类系统价格分类别3500元、4500元等', 10, 0),
(3, '产品 商品', '我们的产品有地方门户系统，CMS系统，B2B电子商务系统，分类信息系统等', 11, 0);
