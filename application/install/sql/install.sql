...
CREATE TABLE `qb_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户收货地址';
...
CREATE TABLE `qb_alonepage` (
  ...
  `ifclose` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否禁用',
...
CREATE TABLE `qb_cms_field` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='文档字段表';
...
CREATE TABLE `qb_config` (
  ...
  KEY `sys_type` (`sys_id`),
  KEY `c_key` (`c_key`)
) ENGINE=MyISAM AUTO_INCREMENT=645 DEFAULT CHARSET=utf8 COMMENT='系统参数配置';
...
CREATE TABLE `qb_config_group` (
  ...
  KEY `ifsys` (`ifsys`),
  KEY `ifshow` (`ifshow`)
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='参数配置分组分类';
...
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='接口(钩子)列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='۳̨әطɕ־';
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='ԃۧև¼ɕ־';
...
CREATE TABLE `qb_memberdata` (
  ...
  `icon` varchar(150) NOT NULL DEFAULT '' COMMENT '会员头像',
...
CREATE TABLE `qb_moneylog` (
  ...
  KEY `uid` (`uid`),
  KEY `city_id` (`city_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='积分日志';
...
CREATE TABLE `qb_scanlogin` (
  ...
  PRIMARY KEY (`id`),
  KEY `sid` (`sid`)
) ENGINE=MEMORY DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='微信扫码PC登录';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='购物车';
...
INSERT INTO `qb_config` VALUES ('266','8','注册可得多少积分','regmoney','5','number','','1','','','96','0');
...
INSERT INTO `qb_config` VALUES ('305','1','远程附件地址','remote_updir','upload_files/web1','text','','1','','','0','0');
...
INSERT INTO `qb_config` VALUES ('335','4','微信公众号AppSecret（应用密钥）','weixin_appsecret','','text','','1','','','99','0');
...
INSERT INTO `qb_config` VALUES ('365','4','微信公众号AppID（应用ID）','weixin_appid','','text','','1','','','100','0');
INSERT INTO `qb_config` VALUES ('366','4','微信支付接口KEY（商户API密钥）','weixin_paykey','','text','','1','','认证服务号才有的微信支付功能，留空就不能收款，填写后，才能在线收款','79','0');
INSERT INTO `qb_config` VALUES ('405','1','备案号','miibeian_gov_cn','京ICP备050453号','','','1','','','0','0');
INSERT INTO `qb_config` VALUES ('425','1','积分名称','MoneyName','金币','text','','1','','可以取名为积分、金币','0','0');
INSERT INTO `qb_config` VALUES ('433','1','站点加密字符串','mymd5','ffa21d584a852f3e3','text','','1','','设置后就不要随意修改，不然会影响到之前的数据','0','0');
...
INSERT INTO `qb_config` VALUES ('473','4','微信对外转帐apiclient_cert证书','weixin_apiclient_cert','','file','','1','','商家对外转帐接口，收款用不到，留空就不能对外转帐','0','0');
INSERT INTO `qb_config` VALUES ('474','4','微信对外转帐apiclient_key证书','weixin_apiclient_key','','file','','1','','商家对外转帐接口，收款用不到，留空就不能对外转帐','0','0');
...
INSERT INTO `qb_config` VALUES ('642','8','前台显示用户的帐号还是昵称','show_nickname','1','radio','0|显示帐号\r\n1|显示昵称','1','','昵称可以随意修改,帐号是固定的','0','0');
...
INSERT INTO `qb_hook` VALUES ('7','upfile_begin','上传文件之前','1','0');
INSERT INTO `qb_hook` VALUES ('8','upfile_end','上传文件之后','1','0');
...
INSERT INTO `qb_log_action` VALUES ('20','1','1526869213','127.0.0.1','admin','hook','add','','{\"name\":\"layout_body_head\",\"about\":\"\\u524d\\u53f0\\u5e03\\u5c40\\u6a21\\u677f\\u5934\\u90e8\",\"ifopen\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('21','1','1526869262','127.0.0.1','admin','hook','add','','{\"name\":\"layout_body\",\"about\":\"\\u524d\\u53f0\\u5e03\\u5c40\\u6a21\\u677f\\u7248\\u6743\\u4fe1\\u606f\\u4e4b\\u4e0a\",\"ifopen\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('22','1','1526869287','127.0.0.1','admin','hook','add','','{\"name\":\"layout_body_foot\",\"about\":\"\\u524d\\u53f0\\u5e03\\u5c40\\u6a21\\u677f\\u5e95\\u90e8\",\"ifopen\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('23','1','1526869306','127.0.0.1','admin','setting','index','','{\"group\":\"1\",\"webname\":\"\\u9f50\\u535aX1.0\",\"seo_title\":\"\\u9f50\\u535a\\u8457\\u540d\\u7684\\u5f00\\u6e90\\u8f6f\\u4ef6\\u63d0\\u4f9b\\u5546\",\"web_open\":\"1\",\"style\":\"default\",\"member_style\":\"default\",\"admin_style\":\"default\",\"forbid_show_bug\":\"1\",\"remote_updir\":\"upload_files\\/web1\",\"upfileType\":\".rar .txt .jpg .gif .bmp .png .zip .mp3 .wma .wmv .mpeg .mpg .rm .ram .htm .doc .swf .avi .flv .sql ..\",\"close_why\":\"\\u7f51\\u7ad9\\u7ef4\\u62a4\\u5f53\\u4e2d,\\u6682\\u505c\\u8bbf\\u95ee.\",\"miibeian_gov_cn\":\"\\u4eacICP\\u5907050453\\u53f7\",\"MoneyName\":\"\\u91d1\\u5e01\",\"mymd5\":\"d612f19c764a69f3305\",\"MoneyDW\":\"\\u5143\",\"group_expire_data\":\"365\",\"copyright\":\"\\u8054\\u7cfb\\u7535\\u8bdd:020-28998648 @\\u5e7f\\u5dde\\u9f50\\u535a\\u7f51\\u7edc\\u79d1\\u6280\\u6709\\u9650\\u516c\\u53f8\"}');
INSERT INTO `qb_log_action` VALUES ('24','1','1528351548','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"90\",\"pk\":\"11\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('25','1','1528351553','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"-1\",\"pk\":\"12\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('26','1','1528351581','127.0.0.1','cms','field','add','','{\"name\":\"keywords\",\"title\":\"SEO\\u5173\\u952e\\u5b57\",\"type\":\"text\",\"field_type\":\"varchar(128) NOT NULL\",\"mid\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('27','1','1528351590','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"095\",\"pk\":\"49\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('28','1','1528351615','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"-1\",\"pk\":\"21\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('29','1','1528351637','127.0.0.1','cms','field','add','','{\"name\":\"keywords\",\"title\":\"SEO\\u5173\\u952e\\u5b57\",\"type\":\"text\",\"field_type\":\"varchar(128) NOT NULL\",\"list\":\"98\",\"mid\":\"2\"}');
INSERT INTO `qb_log_action` VALUES ('30','1','1528351664','127.0.0.1','cms','field','add','','{\"name\":\"keywords\",\"title\":\"SEO\\u5173\\u952e\\u5b57\",\"type\":\"text\",\"field_type\":\"varchar(128) NOT NULL\",\"mid\":\"3\"}');
INSERT INTO `qb_log_action` VALUES ('31','1','1528351674','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"-1\",\"pk\":\"24\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('32','1','1528351681','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"90\",\"pk\":\"23\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('33','1','1528351684','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"80\",\"pk\":\"26\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('34','1','1528351691','127.0.0.1','cms','field','quickedit','','{\"name\":\"list\",\"value\":\"098\",\"pk\":\"51\",\"_t\":\"93872a1e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('35','1','1528351720','127.0.0.1','shop','field','add','','{\"name\":\"keywords\",\"title\":\"SEO\\u5173\\u952e\\u5b57\",\"type\":\"text\",\"field_type\":\"varchar(128) NOT NULL\",\"mid\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('36','1','1528351732','127.0.0.1','shop','field','quickedit','','{\"name\":\"list\",\"value\":\"95\",\"pk\":\"47\",\"_t\":\"7782037e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('37','1','1528351736','127.0.0.1','shop','field','quickedit','','{\"name\":\"list\",\"value\":\"90\",\"pk\":\"11\",\"_t\":\"7782037e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('38','1','1528351741','127.0.0.1','shop','field','quickedit','','{\"name\":\"list\",\"value\":\"0-1\",\"pk\":\"12\",\"_t\":\"7782037e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('39','1','1528351746','127.0.0.1','shop','field','quickedit','','{\"name\":\"list\",\"value\":\"98\",\"pk\":\"51\",\"_t\":\"7782037e\",\"type\":\"text\"}');
INSERT INTO `qb_log_action` VALUES ('40','1','1528351779','127.0.0.1','admin','setting','index','','{\"group\":\"1\",\"webname\":\"\\u9f50\\u535aX1.0\",\"seo_title\":\"\\u9f50\\u535a\\u8457\\u540d\\u7684\\u5f00\\u6e90\\u8f6f\\u4ef6\\u63d0\\u4f9b\\u5546\",\"web_open\":\"1\",\"style\":\"default\",\"member_style\":\"default\",\"admin_style\":\"default\",\"forbid_show_bug\":\"1\",\"remote_updir\":\"upload_files\\/web1\",\"upfileType\":\".rar .txt .jpg .gif .bmp .png .zip .mp3 .wma .wmv .mpeg .mpg .rm .ram .htm .doc .swf .avi .flv .sql ..\",\"close_why\":\"\\u7f51\\u7ad9\\u7ef4\\u62a4\\u5f53\\u4e2d,\\u6682\\u505c\\u8bbf\\u95ee.\",\"miibeian_gov_cn\":\"\\u4eacICP\\u5907050453\\u53f7\",\"MoneyName\":\"\\u91d1\\u5e01\",\"mymd5\":\"ffa21d584a852f3e3\",\"MoneyDW\":\"\\u5143\",\"group_expire_data\":\"365\",\"copyright\":\"\\u8054\\u7cfb\\u7535\\u8bdd:020-28998648 @\\u5e7f\\u5dde\\u9f50\\u535a\\u7f51\\u7edc\\u79d1\\u6280\\u6709\\u9650\\u516c\\u53f8\"}');
INSERT INTO `qb_log_action` VALUES ('41','1','1528352651','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"467\",\"title\":\"PC\\u7248\\u652f\\u4ed8\\u5b9d\\u63a5\\u53e3\\u7c7b\\u578b\",\"c_key\":\"alipay_service\",\"type\":\"11\",\"form_type\":\"radio\",\"options\":\"create_direct_pay_by_user|\\u5373\\u65f6\\u5230\\u8d26\\r\\n\",\"c_descrip\":\"\\u53ea\\u80fd\\u9009\\u62e9\\u7b2c\\u4e00\\u9879\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_action` VALUES ('42','1','1528352651','127.0.0.1','admin','plugin','execute','config_set/config/edit','{\"id\":\"467\",\"title\":\"PC\\u7248\\u652f\\u4ed8\\u5b9d\\u63a5\\u53e3\\u7c7b\\u578b\",\"c_key\":\"alipay_service\",\"type\":\"11\",\"form_type\":\"radio\",\"options\":\"create_direct_pay_by_user|\\u5373\\u65f6\\u5230\\u8d26\\r\\n\",\"c_descrip\":\"\\u53ea\\u80fd\\u9009\\u62e9\\u7b2c\\u4e00\\u9879\",\"ifsys\":\"1\"}');
INSERT INTO `qb_log_login` VALUES ('3','1','127.0.0.1','1526868885','admin','21232f297a57a5a743894a0e4a801fc3');
INSERT INTO `qb_log_login` VALUES ('4','1','127.0.0.1','1526869218','admin','21232f297a57a5a743894a0e4a801fc3');
INSERT INTO `qb_log_login` VALUES ('5','1','127.0.0.1','1528008805','admin','21232f297a57a5a743894a0e4a801fc3');
INSERT INTO `qb_log_login` VALUES ('6','1','127.0.0.1','1528351526','admin','21232f297a57a5a743894a0e4a801fc3');
INSERT INTO `qb_memberdata` VALUES ('1','4b885f0bd98c302dad7652c001a9273b','3db45','admin','我是超管','','wf','','3','1','','1','186','8774571','1528351526','127.0.0.1','1528351521','127.0.0.1','1','1890-00-00','uploads/images/20180320/719d42cdf564010d411f2be85c5f47b9.jpeg','fdfdf','','bb@126.com','0','1','cvbnmmm','13399999999','','张学友','a:4:{s:7:\"endtime\";s:0:\"\";s:9:\"alipay_id\";s:6:\"666666\";s:4:\"bank\";s:114:\"62223333333333373 张三 中国工商银行北京**支行\n62284444444919 张三 中国农业银行北京***分行\";s:7:\"pay_pwd\";s:1:\"3\";}','0','0','0','77.90','359.00','e10adc3949ba59abbe56e057f20f883e','22','0','0','0','a:1:{s:6:\"RegMsg\";i:1;}');
...
INSERT INTO `qb_plugin` VALUES ('5','0','marketing','营销功能','fa fa-fw fa-users','','','','','','0','0','100','1','1','0');
...
INSERT INTO `qb_shop_field` VALUES ('51','keywords','SEO关键字','text','varchar(128) NOT NULL','','','','1','1','','','','','','2','','','','98','0','0','0','');
...
INSERT INTO `qb_webmenu` VALUES ('26','0','3','我的圈子','/index.php/qun/content/my.html','0','1','10','glyphicon glyphicon-star','');
INSERT INTO `qb_webmenu` VALUES ('27','0','3','圈子广场','/index.php/qun/index/index.html','0','1','9','glyphicon glyphicon-bullhorn','');
INSERT INTO `qb_webmenu` VALUES ('28','0','3','创建圈子','/index.php/qun/content/add.html','0','1','8','glyphicon glyphicon-plus','');
INSERT INTO `qb_webmenu` VALUES ('29','0','3','会员中心','/member.php/member/index.html','0','1','0','si si-user','');
