...
<div class="col-sm-12 js-upload-file">
        <ul class="list-group uploader-list" id="file_list_{$name}">
            <li class="list-group-item file-item"><i class="fa fa-times-circle remove-file"></i>{$info[$name]}</li>
         </ul>
        <input type="hidden" name="{$name}" data-multiple="false" data-size="0" data-ext='' id="{$name}" value="1">
