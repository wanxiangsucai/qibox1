...
class WxPayDataBase
{
	...
	**/
	...
	{	
        ...
        //将XML转为array
        //禁止引用外部xml实体
        if(function_exists('libxml_disable_entity_loader')){libxml_disable_entity_loader(true);} //libxml齐博修改，PHP 5 >= 5.2.11 libxml要2.7.7以上版本才支持
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
		$string = $string . "&key=".WxPayConfig__KEY;
		//签名步骤三：MD5加密
		$string = md5($string);
		//签名步骤四：所有字符转为大写
