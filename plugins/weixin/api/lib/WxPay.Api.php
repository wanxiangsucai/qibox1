...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetMch_id(WxPayConfig::payid());//商户号
	...
	public static function report($inputObj, $timeOut = 1)
	{
		...
		$inputObj->SetAppid( config('webdb.weixin_appid') //WxPayConfig::appid()
		    );//公众账号ID
		$inputObj->SetMch_id( config('webdb.weixin_payid') //WxPayConfig::payid()
		    );//商户号
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT,WxPayConfig::sslcert() );
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, WxPayConfig::sslkey() );
		}
		//post提交方式
